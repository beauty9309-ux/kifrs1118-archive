...
- **실질 상세(소수만 별도 페이지):** 마스터 대조로 **확정된 5건** — 제1007호 현금흐름표 ✅ · 제1008호 재무제표의 작성 기준 ✅ · 제1033호 주당이익 · 제1034호 중간재무보고 · 제1101호 최초채택. (✅ = 작성 완료)
  - 당초 후보였던 **제1012호 법인세 · 제1105호 매각예정·중단영업은 대조 결과 경미**로 판정 — 지도 표의 행으로만 둔다.
...
> **바로 착수하려면 [`NEXT-SESSION.md`](NEXT-SESSION.md)를 연다.** 색인 요청용 URL 목록, 20개 페이지 검증 워크시트(소스 파일·줄 번호·AI가 해석한 지점 표시), 선택 산출물 착수 프롬프트가 들어 있다.
